...
const CandidateButtonPopup = ({ 
    ...
    return (
        <div className={`fixed inset-0 overflow-y-auto z-50 ${!isOpen && 'hidden'}`} aria-labelledby="modal-title" role="dialog" aria-modal="true">
                ...
                <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle w-[75%]">
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div
                            ...
                            style={{
                                gridTemplateColumns: `repeat(${popup.columns || 1}, minmax(0, 1fr))`
                            }}
                        >
