...
const CandidateForm = () => {
  ...
  return (
    <div className="p-4">
      <h2 className="text-2xl font-bold mb-4">Candidate Submission Form</h2>
                ...
                <div key={field}>
                  ...
                  {field === 'assessed' ? (
                    <input
                      ...
                      onChange={(e) => handleInputChange(index, { target: { name: field, value: e.target.checked } })}
                  ...
                  {errors[`candidates.${index}.${field}`] && (
                    <p className="mt-1 text-sm text-red-600">{errors[`candidates.${index}.${field}`]}</p>
                  )}
                </div>
              ))}
            </div>
